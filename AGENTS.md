...
## Architecture
- `app/src/main/java/com/cuentamorosos/ui`: UI components and screens.
- `app/src/main/java/com/cuentamorosos/model`: Data models and calculation engines.
- `app/src/main/java/com/cuentamorosos/data`: Local storage and notification services.
...
- **Persistence**: Data is persisted via `CuentaMorososLocalStore`. Always call `persistData()` (or equivalent) after modifying state lists.
